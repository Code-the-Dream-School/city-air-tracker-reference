...
| 7 | Optional extensions | AIR-006, AIR-008, AIR-011, AIR-013, AIR-014, AIR-015, plus cohort-proposed enhancements. See [Week 7 optional extensions](./week7.md) for the extension menu and story-point estimates. | Pick extension work based on team interest, remaining time, and instructor guidance. | 123 available; recommend 8-13 selected |
